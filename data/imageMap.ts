...
export const imageMap: Record<string, number> = {
  ...
  compass: require("../assets/icons/star.png"),
  ...
  "face-scan": require("../assets/icons/face.png"),
  "tarot-cards": require("../assets/icons/tarot.png"),
  palm: require("../assets/icons/hand.png"),
  angel: require("../assets/icons/angel.png"),
  "crystal-ball": require("../assets/icons/crystal.png"),

  // Activities
  cookie: require("../assets/icons/cookie.png"),
  sparkles: require("../assets/icons/fun.png"),
  "refresh-circle": require("../assets/icons/wheel.png"),
  wheel: require("../assets/icons/wheel.png"),
  "shake-gift": require("../assets/icons/shake.png"),
